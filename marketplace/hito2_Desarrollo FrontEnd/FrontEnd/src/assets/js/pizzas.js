/* // Datos vacios Para comprobar que los datos son cargados desde la API
export const pizzas = [
    {
      desc: "",
      id: "",
  ...
  */
// Estos valores pueden ser reemplazados x la info actualizada de la API
  export const pizzas = [
    {
      ...
      name: "napolitana",
      price: 6000,  //valor en la API = 5950
    },
    {
  ...
  // Simulación de un carrito de compras no actualizado por ahora los precios desde API
  export const pizzaCart = [
